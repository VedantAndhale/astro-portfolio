    ...
    <div class="flex flex-col gap-6">
      ...
      <div class="w-full">
        <PremiumFilter
          ...
          title="Filter Posts"
          description="Select tags to filter blog posts"
        />
      </div>
      ...
      <div class="flex justify-between items-center mb-2 bg-gradient-to-br from-white to-gray-50/80 dark:from-gray-900 dark:to-gray-800/80 backdrop-blur-lg rounded-xl border border-gray-200/50 dark:border-gray-700/30 shadow-md p-4">
        <div class="text-sm font-medium text-gray-700 dark:text-gray-300">
          Showing <span class="font-semibold text-blue-600 dark:text-blue-400">{posts().length}</span> of <span class="font-semibold">{data.length}</span> posts
        </div>
